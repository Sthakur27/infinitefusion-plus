...
class PokemonStorageScreen
  ...
  # sidmod: PC search (see Menus/PC/PCSearch.rb), reached from pbBoxCommands
  ...
  # NOTE: upstream 6.8 removed boxCommandTransferInfo along with its caller; the
  # disclaimer now lives in Settings::TRANSFER_BOX_DISCLAIMER_MESSAGE. Dropped to
  # match upstream rather than leaving an uncalled method behind.
  def boxCommandName
