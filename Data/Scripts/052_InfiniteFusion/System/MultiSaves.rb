...
class PokemonLoadScreen
  ...
  def pbStartLoadScreen
    ...
    # sidmod: silence startup announcements (PIF2/Hoenn ads). Upstream 6.8 split the
    # single STARTUP_MESSAGES into per-region blocks, so both are gated off.
    if false && Settings::STARTUP_MESSAGES_KANTO != "" && Settings::KANTO
      pbMessage(_INTL(Settings::STARTUP_MESSAGES_KANTO))
    end
    if false && Settings::STARTUP_MESSAGES_HOENN != "" && Settings::HOENN
