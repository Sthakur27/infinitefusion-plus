...
teams["OUSand"] = [
  ...
  m("GARCHOMP","DONPHAN","SANDVEIL","CHOICESCARF","JOLLY",%w[EARTHQUAKE STONEEDGE OUTRAGE FIREPUNCH],PHYS),
  m("FERROTHORN","SKARMORY","IRONBARBS","LEFTOVERS","IMPISH",%w[STEALTHROCK SPIKES LEECHSEED WHIRLWIND],PDEF),
  m("TYRANITAR","DRAGONITE","SANDSTREAM","CHOICEBAND","ADAMANT",%w[STONEEDGE EARTHQUAKE CRUNCH FIREPUNCH],PHYS),
  m("GLISCOR","MILOTIC","POISONHEAL","TOXICORB","IMPISH",%w[EARTHQUAKE TOXIC ROOST PROTECT],PDEF),
  m("DRAGONITE","SCIZOR","MULTISCALE","LEFTOVERS","ADAMANT",%w[DRAGONDANCE DRAGONCLAW EARTHQUAKE ROOST],PHYS),
]
# ---------- UBERS 1 (BALANCE) ----------
teams["Ubers1"] = [
  m("DARKRAI","GROUDON","BADDREAMS","LIFEORB","TIMID",%w[NASTYPLOT DARKPULSE EARTHPOWER FOCUSBLAST],SPEC),
  ...
  m("KYUREM","DIALGA","MOXIE","CHOICESCARF","JOLLY",%w[DRAGONCLAW ICICLECRASH EARTHQUAKE IRONHEAD],PHYS),
