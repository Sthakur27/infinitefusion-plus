...
teams["OUSand"] = [
  ...
  m("GARCHOMP","SALAMENCE","MOXIE","CHOICESCARF","JOLLY",%w[EARTHQUAKE OUTRAGE STONEEDGE FIREPUNCH],PHYS),
  m("FERROTHORN","SKARMORY","IRONBARBS","LEFTOVERS","IMPISH",%w[STEALTHROCK SPIKES LEECHSEED WHIRLWIND],PDEF),
  m("RHYPERIOR","AGGRON","SOLIDROCK","CHOICEBAND","ADAMANT",%w[STONEEDGE EARTHQUAKE ICEPUNCH MEGAHORN],PHYS),
  m("GLISCOR","MILOTIC","POISONHEAL","TOXICORB","IMPISH",%w[EARTHQUAKE TOXIC ROOST PROTECT],PDEF),
  m("DRAGONITE","SCIZOR","MULTISCALE","LEFTOVERS","ADAMANT",%w[DRAGONDANCE DRAGONCLAW EARTHQUAKE ROOST],PHYS),
]
# ---------- UBERS 1 (BALANCE) ----------
teams["Ubers1"] = [
  m("DARKRAI","NIDOKING","SHEERFORCE","LIFEORB","TIMID",%w[NASTYPLOT DARKPULSE EARTHPOWER SLUDGEWAVE],SPEC),
  ...
  m("KYUREM","SALAMENCE","MOXIE","CHOICESCARF","JOLLY",%w[DRAGONCLAW ICICLECRASH EARTHQUAKE STONEEDGE],PHYS),
