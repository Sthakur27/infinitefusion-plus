...
teams["OURain"] = [
  ...
  m("KABUTOPS","KINGLER","SWIFTSWIM","LIFEORB","ADAMANT",%w[SWORDSDANCE WATERFALL STONEEDGE AQUAJET],PHYS),
...
teams["OUSand"] = [
  ...
  m("GARCHOMP","DONPHAN","SANDVEIL","LIFEORB","JOLLY",%w[SWORDSDANCE EARTHQUAKE STONEEDGE OUTRAGE],PHYS),
  m("FERROTHORN","SKARMORY","IRONBARBS","LEFTOVERS","IMPISH",%w[STEALTHROCK SPIKES LEECHSEED WHIRLWIND],PDEF),
  m("CRADILY","FERROTHORN","STORMDRAIN","LEFTOVERS","CAREFUL",%w[RECOVER GIGADRAIN TOXIC ROCKSLIDE],SDEF),
  m("GLISCOR","MILOTIC","POISONHEAL","TOXICORB","IMPISH",%w[EARTHQUAKE TOXIC ROOST PROTECT],PDEF),
  m("DRAGONITE","SCIZOR","MULTISCALE","LEFTOVERS","ADAMANT",%w[DRAGONDANCE DRAGONCLAW EARTHQUAKE ROOST],PHYS),
]
# ---------- UBERS 1 (BALANCE) ----------
teams["Ubers1"] = [
  ...
  m("BLISSEY","LUGIA","NATURALCURE","LEFTOVERS","BOLD",%w[SEISMICTOSS TOXIC SOFTBOILED THUNDERWAVE],PDEF),
